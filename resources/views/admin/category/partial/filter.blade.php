<div class="btn-group news-category">
...
$(document).ready(function(){
    ...
    $(".news-category .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/news.category.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".news-category .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.news-category .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'news.category.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#news-category-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#news-category-list .btn-reset-filter').css('display', 'none');
