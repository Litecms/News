<div class="btn-group news-comment">
...
<div class="container-fluid">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[news_id]" class="col-sm-2 control-label">
                                        {!! trans('news::comment.label.news_id')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[news_id]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            </div>
...
$(document).ready(function(){
    ...
    $(".news-comment .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/news.comment.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".news-comment .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.news-comment .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'news.comment.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#news-comment-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#news-comment-list .btn-reset-filter').css('display', 'none');
