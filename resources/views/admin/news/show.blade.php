    <div class="nav-tabs-custom">
        ...
        <ul class="nav nav-tabs primary">
            <li role="presentation" class="active"><a href="#news" area-controls="news" role="tab" data-toggle="tab">News</a></li>
            ...
            <div class="box-tools pull-right">
                ...
                @if($news['published'] == 'Yes')
                    <button type="button" class="btn btn-default btn-sm" data-action="REQUEST" data-load-to='#news-news-entry' data-href='{{ guard_url('news/publish') }}/{{$news->getRouteKey()}}/unpublish'><i class="fa fa-times"></i> Unpublish</button>
                    
                @else
                     <button type="button" class="btn btn-warning btn-sm" data-action="REQUEST" data-load-to='#news-news-entry' data-href='{{ guard_url('news/publish') }}/{{$news->getRouteKey()}}/publish'><i class="fa fa-check"></i> Publish</button>
        ...
        ->action(guard_url('news/news'))!!}
            <div class="tab-content clearfix disabled">
                <div class="tab-pan-title"> {{ trans('app.view') }}   {!! trans('news::news.name') !!}  [{!! $news->title !!}] 
                @if($news['published'] == 'Yes') Published @else Unpublished @endif</div>
