                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[category_id]" class="col-sm-2 control-label">
                                        {!! trans('news::news.label.category_id')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[published]" class="col-sm-2 control-label">
                                        {!! trans('news::news.label.published')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[user_type]" class="col-sm-2 control-label">
                                        {!! trans('news::news.label.user_type')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[created_at]" class="col-sm-2 control-label">
                                        {!! trans('news::news.label.created_at')!!}
                                    </label>
                                    <div class="col-sm-10">
...
$(document).ready(function(){
    ...
    $(".news-news .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/news.news.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".news-news .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.news-news .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'news.news.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#news-news-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#news-news-list .btn-reset-filter').css('display', 'none');
