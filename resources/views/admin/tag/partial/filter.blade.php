...
$(document).ready(function(){
    ...
    $(".news-tag .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/news.tag.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".news-tag .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.news-tag .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'news.tag.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#news-tag-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#news-tag-list .btn-reset-filter').css('display', 'none');
