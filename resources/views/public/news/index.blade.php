        ...
        <div class="row m-t-40">
            <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                ...
                <div class="news-list-item">
                        ...
                        <a  href="{{trans_url('news')}}/{{@$value['slug']}}"> <img class="img-responsive" alt="" src="{!!trans_url('/image/sl/'.$value->default_image)!!}"></a>
                       <!--  <img src="{!!trans_url('image/sl/')!!}/{!!trans_url($value->default_image)!!}" class=" img-responsive" alt="" > -->
                        @else
                       <a  href="{{trans_url('news')}}/{{@$value['slug']}}"> <img alt="" class="img-responsive" src="img/blog1.jpg"></a>
                        @endif
                        ...
                        <div class="blog-list-inner-desc">
                            ...
                            <div class="blog-detail-desc">
                                <p class="detail-tags m-b-20">
                                    ...
                                    {{@$value->user['name']}} on {{$day}} , {{$value['published_on']}}
                                </p>
